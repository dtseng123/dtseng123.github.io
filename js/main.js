 ...
 *
****************************************************************************************************/
DTSENG.slideDownHead = function(option){
	if(option){
 ...
 *
****************************************************************************************************/
DTSENG.parallax = function(option){
 ...
 *
****************************************************************************************************/
DTSENG.slider = function(selector, options){
 ...
 *
****************************************************************************************************/
DTSENG.owlCarousel = function (options){
 ...
 *
****************************************************************************************************/
DTSENG.skillbar = function(animated){
 ...
 *
****************************************************************************************************/
DTSENG.videoBgYT = function(selector,video){
	if(!Modernizr.touch){
 ...
 *
****************************************************************************************************/
DTSENG.bootstrapCarousel = function (options){
 ...
 *
****************************************************************************************************/	
DTSENG.fitVids = function (selector){	
	$(selector).fitVids();	      
};
/****************************************************************************************************
 * PORTFOLIO FILTER
...
DTSENG.portfolioFilter = function (selector, item){
...
DTSENG.portfolio = function (selector,options){
 ...
 *
****************************************************************************************************/			
DTSENG.scrollAnim = function(option){	
		$(window).load(function() {
			if(option == "yes"){		
 ...
 *
****************************************************************************************************/
DTSENG.magnific = function (options){
